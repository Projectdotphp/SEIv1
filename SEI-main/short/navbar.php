<nav class="navbar navbar-expand-lg bg-white navbar-light  sticky-top p-0">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse" style="margin-right: 50px;">
        ...
        <div class="navbar-nav ms-auto p-4 p-lg-0" >
            ...
            <a href="./home.php" class="nav-item nav-link fw-bold">Home</a>
            <!-- Dromdowns -->
            <div class="nav-item fw-bold dropdown">
                <a href="#" class="nav-link fw-bold" data-bs-toggle="dropdown">About</a>
                <div class="dropdown-menu fade-up m-0">
                    <a href="./pages/sei" class="dropdown-item fw-bold">About Product</a>
                    <a href="./pages/company" class="dropdown-item fw-bold">About Company</a>
                    <a class="dropdown-item "id="myid"></a>
                </div>
            </div>
            <a href="./service.php" class="nav-item nav-link fw-bold">Services</a>
            <a href="./product.php" class="nav-item nav-link fw-bold">Products</a>
            <a href="./media.php" class="nav-item nav-link fw-bold">Media</a>
            <a href="./contact.php" class="nav-item nav-link  fw-bold">Contact</a>
